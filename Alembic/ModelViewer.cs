...
namespace ACViewer
{
    public class ModelViewer
    {
        ...
        public static Camera Camera => GameView.PreviewMode == ViewMode.Model || GameView.PreviewMode == ViewMode.WorldObject ? GameView.PreviewCamera : GameView.Camera;
        ...
        public void Update(GameTime time)
        {
            ...
            // Skip input handling if this is a preview
            if (GameView.PreviewMode == ViewMode.Model || GameView.PreviewMode == ViewMode.WorldObject)
                return;
        ...
        public void Draw(GameTime time, bool isPreview = false)
        {
            ...
            switch (ModelType)
            {
                ...
                case ModelType.Environment:
                    DrawEnvironment(isPreview);
                    break;
                case ModelType.EnvCell:
                    DrawEnvCell(isPreview);
                    break;
            }

            if (MainMenu.ShowHUD && !isPreview)
        ...
        public void DrawModel(bool isPreview = false)
        {
            if (Setup == null) return;

            if (!isPreview)
                GraphicsDevice.Clear(ConfigManager.Config.BackgroundColors.FontColor);
        ...
        public void DrawEnvironment(bool isPreview = false)
        {
        ...
        public void DrawEnvCell(bool isPreview = false)
        {
            if (!isPreview)
                GraphicsDevice.Clear(ConfigManager.Config.BackgroundColors.FontColor);
