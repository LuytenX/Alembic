...
namespace ACViewer.Render
{
    public class Buffer
    {
        ...
        public void ClearBuffer(ParticleBatch batch)
        {
            batch.Dispose();
                ...
                public void AddOutdoor(R_Landblock landblock) { 
                    ...
                    AddEnvCells(landblock); // RESTORED: Render rooms and interior objects
        ...
        {
            if (landblock.StaticObjs == null) return;
        ...
        public void AddInstanceObj(R_PhysicsObj obj, Dictionary<uint, GfxObjInstance_Shared> batches)
        {
            foreach (var part in obj.PartArray.Parts)
            {
                ...
                // BACKLINK: Enable real-time visual updates for this object
        ...
        {
            if (landblock.Buildings == null) return;
        ...
        {
            if (landblock.Scenery == null) return;
        ...
        {
            if (landblock.EnvCells == null) return;
        ...
        public void BuildBuffers()
        {
            ...
            // Build animated buffer as well to ensure it's properly initialized for player rendering
            BuildBuffer(RB_Animated);
        ...
        public static void SetRasterizerState(CullMode cullMode = CullMode.None)
        {
